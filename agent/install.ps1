...
if ($InstallVersion -ne "") {
    ...
    $ApiUrl = "https://api.github.com/repos/kadidalax/komari-classic/releases/latest"
    try {
...
$BinaryName = "komari-agent-windows-$arch.exe"
$DownloadUrl = if ($GitHubProxy) { "$GitHubProxy/https://github.com/kadidalax/komari-classic/releases/download/$versionToInstall/$BinaryName" } else { "https://github.com/kadidalax/komari-classic/releases/download/$versionToInstall/$BinaryName" }
