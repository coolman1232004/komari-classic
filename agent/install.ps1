...
if ($InstallVersion -ne "") {
    ...
    $ApiUrl = "https://api.github.com/repos/coolman1232004/komari-classic/releases/latest"
    try {
...
$BinaryName = "komari-agent-windows-$arch.exe"
$DownloadUrl = if ($GitHubProxy) { "$GitHubProxy/https://github.com/coolman1232004/komari-classic/releases/download/$versionToInstall/$BinaryName" } else { "https://github.com/coolman1232004/komari-classic/releases/download/$versionToInstall/$BinaryName" }
