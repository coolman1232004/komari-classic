...
export function ActionsCell({ row }: { row: Row<z.infer<typeof schema>> }) {
  ...
  const generateCommand = () => {
    ...
    switch (selectedPlatform) {
      case "linux":
        finalCommand =
          `wget -qO- https://raw.githubusercontent.com/coolman1232004/komari-classic/refs/heads/main/agent/install.sh | sudo bash -s -- ` +
          quoteShellArgs(args);
        break;
      case "windows":
        finalCommand =
          `powershell.exe -NoProfile -ExecutionPolicy Bypass -Command ` +
          `"iwr 'https://raw.githubusercontent.com/coolman1232004/komari-classic/refs/heads/main/agent/install.ps1'` +
      ...
      case "macos":
        finalCommand =
          `zsh <(curl -sL https://raw.githubusercontent.com/coolman1232004/komari-classic/refs/heads/main/agent/install.sh) ` +
          quoteShellArgs(args);
        break;
    }
    return finalCommand;
