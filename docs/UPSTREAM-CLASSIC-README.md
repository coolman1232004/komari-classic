# Historical baseline README

The text below is retained for provenance. Its images/installers are not the hardened release. Use the repository root README for current installation.
